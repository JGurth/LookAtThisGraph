...
for i in [256, 512, 1024, 1536, 2048, 2560, 3072]:
    train_config = {
            'learning_rate': 7e-4,
    ...
    filename="Results/BatchSize/kAcc_"+train_config['net'](1,1).__class__.__name__+"_"+train_config['training_target']+"_"+dt.datetime.now().strftime("%d-%m-%Y_%H-%M")+".txt"
